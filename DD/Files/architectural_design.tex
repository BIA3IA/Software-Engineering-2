...
\begin{itemize}
	...
	\item \textbf{Application Tier:}
	      ...
	      TLS termination is performed at the WAF to allow full request inspection; validated traffic is then forwarded to the internal
	      gateway node running \textit{NGINX} over HTTPS.
