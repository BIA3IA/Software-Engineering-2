...
information are delegated to the application layer. The mobile application also uses
...
\figure[H]
\centering
\includegraphics[width=\textwidth]{Images/ArchitecturalOverview/component_view.png}
