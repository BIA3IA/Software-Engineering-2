...
app and the backend. It is not a standalone gateway component, 
it is a logical layer implemented inside the backend application. It centralizes request routing
...
request to the backend through the \textbf{API Entrypoint}. The gateway forwards the request
