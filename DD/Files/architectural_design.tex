...
\begin{itemize}
	...
	\item \textbf{SnappingService}: maps raw GPS traces to road geometry to improve
...
it interacts with the \textbf{SnappingService} to snap drawn or recorded paths to
the road network.
...
snap user-drawn or recorded paths to the road network, ensuring accurate route representation.
...
snapshot through the \textbf{WeatherService} based on the trip time and location.
It then saves the complete trip data, including weather information if available.
