...
In recent years, cycling has gained increasing relevance as a sustainable, healthy, and efficient
means of transportation. Despite its benefits, cyclists often face difficulties in identifying safe
and reliable routes. The \textbf{Best Bike Paths (BBP)} system has been conceived to address these challenges by using
community-contributed data and sensor information to help users choose safer and more reliable
cycling routes.
...
The purpose of this document is to translate the system requirements defined in the \textbf{Requirement Analysis
	and Specification Document (RASD)} into architectural, component-level,
...
\begin{itemize}
	...
	\item Version 2.0 (01 February 2026 - minor changes in Architectural Design chapter, Implementation, Integration and Test Plan chapter and Requirements Traceability chapter).;
\end{itemize}
