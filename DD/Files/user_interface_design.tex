...
The screen displays the app logo, the application name, and a short tagline summarizing
...
Home, Trip History, Path History, and User Profile.
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.5\textwidth]{Design/8_mode.png}
...
\begin{figure}[H]
    ...
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{Design/9_in_trip.png}
    ...
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{Design/9_in_trip_guest.png}
...
\begin{figure}[H]
    ...
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{Design/10_trip_completed.png}
    ...
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{Design/10_trip_completed_guest.png}
...
\begin{figure}[H]
    ...
    \begin{minipage}{0.48\textwidth}
		\centering
		\includegraphics[width=\textwidth]{Design/11_report.png}
	...
	\begin{minipage}{0.48\textwidth}
		\centering
		\includegraphics[width=\textwidth]{Design/11_report_success.png}
		\caption{Report Submission Success Message Mockup}
		\label{fig:report_submission_success_mockup}
	\end{minipage}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.5\textwidth]{Design/12_confirm_report.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.5\textwidth]{Design/13_create.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.5\textwidth]{Design/14_during_creation.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.5\textwidth]{Design/15_creation_completed.png}
...
\begin{figure}[H]
	...
	\begin{minipage}{0.48\textwidth}
		\centering
		\includegraphics[width=\textwidth]{Design/16_trip_history.png}
	...
	\begin{minipage}{0.48\textwidth}
		\centering
		\includegraphics[width=\textwidth]{Design/16_trip_order.png}
		\caption{Trip Sorting Options Mockup}
...
\begin{figure}[H]
	...
	\begin{minipage}{0.48\textwidth}
		\centering
		\includegraphics[width=\textwidth]{Design/16_trip_expanded.png}
		\caption{Trip History Details Mockup}
		\label{fig:trip_history_details_mockup}
	\end{minipage}
	\hfill
	\begin{minipage}{0.48\textwidth}
		\centering
		\includegraphics[width=\textwidth]{Design/16_trip_stats.png}
		\caption{Trip Statistics Mockup}
...
\begin{figure}[H]
	...
	\begin{minipage}{0.48\textwidth}
		\centering
		\includegraphics[width=\textwidth]{Design/16_trip_weather.png}
	\caption{Trip Weather Details Mockup}
	\label{fig:trip_weather_details_mockup}	
	\end{minipage}
	\hfill
	\begin{minipage}{0.48\textwidth}
		\centering
		\includegraphics[width=\textwidth]{Design/16_delete_trip.png}
		\caption{Trip Deletion Confirmation Mockup}
		\label{fig:trip_deletion_confirmation_mockup}
	\end{minipage}
\end{figure}

\subsection{My Paths Screen}
\label{sec:my_paths_screen}%
...
\begin{figure}[H]
	...
	\begin{minipage}{0.48\textwidth}
		\centering
		\includegraphics[width=\textwidth]{Design/17_paths.png}
		\caption{My Paths Screen Mockup}
		\label{fig:my_paths_screen_mockup}
	\end{minipage}
	\hfill
	\begin{minipage}{0.48\textwidth}
		\centering
		\includegraphics[width=\textwidth]{Design/17_path_expanded.png}
		\caption{Path Details Mockup}
...
\begin{figure}[H]
	...
	\begin{minipage}{0.48\textwidth}
		\centering
		\includegraphics[width=\textwidth]{Design/17_path_visibility.png}
		\caption{Path Visibility Toggle Mockup}
		\label{fig:path_visibility_toggle_mockup}
	\end{minipage}
	\hfill
	\begin{minipage}{0.48\textwidth}
		\centering
		\includegraphics[width=\textwidth]{Design/17_delete_path.png}
		\caption{Path Deletion Confirmation Mockup}
...
All information in this section is available exclusively to logged-in usersGuests cannot access 
the Profile screen or view personal statistics.

\begin{figure}[H]
	\centering
	\includegraphics[width=0.5\textwidth]{Design/18_profile.png}
...
The Personal Information screen allows logged-in users to update their account details.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{Design/19_edit_profile.png}
...
% TODO add biking prompt section, a section that describes only the flow, and make a shadow around the images