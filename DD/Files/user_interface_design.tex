...
\newcommand{\phoneimage}[2][]{%
	\begin{tikzpicture}[baseline=(img.base)]
		...
		\node[
			inner sep=0pt,
			outer sep=0pt,
			rounded corners=13pt, % regola se vuoi più o meno tondo
			clip
...
\begin{figure}[H]
	\centering
	\phoneimage[width=0.5\textwidth]{Design/5_unlock.png}
...
\begin{figure}[H]
	...
	\begin{minipage}{0.48\textwidth}
		...
		\caption{Automatic Ride Detection Pop-up Mockup}
	...
	\begin{minipage}{0.48\textwidth}
		...
		\caption{Automatic Ride Detection Pop-up  Mockup for Guest Users}
...
\begin{figure}[H]
	\centering
	\phoneimage[width=0.5\textwidth]{Design/8_mode.png}
	\caption{Automatic Mode Activation Pop-up Mockup}
...
\begin{figure}[H]
	...
	\begin{minipage}{0.48\textwidth}
		...
		\caption{Trip Completion Pop-up Mockup}
	...
	\begin{minipage}{0.48\textwidth}
		...
		\caption{Trip Completion Pop-up Mockup for Guest Users}
...
\begin{figure}[H]
	...
	\begin{minipage}{0.48\textwidth}
		...
		\caption{Report Submission Success Pop-up Mockup}
...
\begin{figure}[H]
	\centering
	\phoneimage[width=0.5\textwidth]{Design/12_confirm_report.png}
...
\begin{figure}[H]
	\centering
	\phoneimage[width=0.5\textwidth]{Design/13_create.png}
...
\begin{figure}[H]
	\centering
	\phoneimage[width=0.5\textwidth]{Design/14_during_creation.png}
...
\begin{figure}[H]
	\centering
	\phoneimage[width=0.5\textwidth]{Design/15_creation_completed.png}
...
\begin{figure}[H]
	\centering
	\phoneimage[width=0.5\textwidth]{Design/18_profile.png}
...
\begin{figure}[H]
	\centering
	\phoneimage[width=0.5\textwidth]{Design/19_edit_profile.png}
	\caption{Edit Profile Mockup}
...
\begin{figure}[H]
	\centering
	\phoneimage[width=0.5\textwidth]{Design/20_settings.png}
...
\begin{figure}[H]
	\centering
	\phoneimage[width=0.5\textwidth]{Design/21_error.png}
