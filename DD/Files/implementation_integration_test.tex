...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{../Images/iit/iit6.png}
    \caption{Step 6: ReportManager Integration}
    \label{fig:iit6}
\end{figure}

After the \texttt{ReportManager}, we integrate the \texttt{StatsManager}. This component aggregates data generated
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{../Images/iit/iit7.png}
    \caption{Step 7: StatsManager Integration}
    \label{fig:iit7}
\end{figure}

After the \texttt{StatsManager}, we integrate the \texttt{CacheingService}. This component is responsible for caching frequently 
accessed data to improve system performance. Integration tests will verify that the caching mechanism correctly stores, retrieves data,
and maintains data consistency with the underlying database. Tests will also ensure that cache invalidation 
policies are correctly implemented to prevent stale data from being served.

\vspace{1cm}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{../Images/iit/iit8.png}
    \caption{Step 7: CacheingService Integration}
    \label{fig:iit7}
\end{figure}
