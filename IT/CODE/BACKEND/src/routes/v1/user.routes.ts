...
userRouter.get('/me', verifyAccessToken, userManager.getProfile.bind(userManager));
userRouter.post('/register', validate(registerSchema), userManager.register.bind(userManager));
userRouter.patch('/me', verifyAccessToken, validate(updateProfileSchema), userManager.updateProfile.bind(userManager));
