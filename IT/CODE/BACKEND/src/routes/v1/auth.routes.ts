...
import { loginSchema, logoutSchema, refreshSchema } from '../../schemas/index.js';
...
authRouter.post('/logout', validate(logoutSchema), authManager.logout.bind(authManager));
authRouter.post('/refresh', validate(refreshSchema), authManager.refresh.bind(authManager));
