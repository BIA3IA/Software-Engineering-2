...
declare global {
  namespace PrismaJson {
    type Coordinates = import("../src/types/index").Coordinates;
    type TripStatistics = import("../src/types/index").TripStatistics;
    type WeatherData = import("../src/types/index").WeatherData;
  }
}
