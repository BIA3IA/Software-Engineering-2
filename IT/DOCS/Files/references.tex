...
\begin{itemize}
	...
	\item "Is Redis persistent, or is data lost on reboot?"
	\item "What's the difference between Redis and Memcached?"
	\item "How do TTL, EXPIRE and setex work?"
	\item "How should cache invalidation be handled correctly?"
	\item "How should I test the Redis cache service with Jest?"
	\item "How can I see if Redis is working correctly and how can I access the service with redis-cli?"
\end{itemize}
