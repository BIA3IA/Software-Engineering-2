...
\puttitle{
	title=Implementation Document, % Title 
...
\input{Files/implemented_functionalities_and_requirements}
\label{ch:Implemented_Functionalities_and_Requirements}%

\chapter{Adopted Development Frameworks}
\input{Files/development}
\label{ch:Development}%

\chapter{Source Code Structure}
\input{Files/source_code_structure}
\label{ch:Source_Code_Structure}%
