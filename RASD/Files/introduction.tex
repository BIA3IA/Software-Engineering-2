...
\begin{itemize}
	...
	\item [\textbf{[SP12]}] A logged-in user starts or stops recording a bike trip.
...
\begin{itemize}
	\item \textbf{Bike Path:} A route defined either by data collected from users or by paths manually created within BBP. A Bike Path consists of one or more Path Segments.
	...
	\item \textbf{Path Score:} The final numerical ranking value computed by the system, based on the path's aggregated status and effectiveness, used to recommend the best alternatives between an origin and a destination.
...
\begin{itemize}
	...
	\item Version 2.0 (23 December 2025);
\end{itemize}
