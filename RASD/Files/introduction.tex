...
\begin{itemize}    
    ...
    \item[\textbf{[G3]}] \textbf{Registered users can track their cycling activities over time}, allowing registered users to monitor their trips and review their past performances.

    \item[\textbf{[G4]}] \textbf{Registered users can contribute to the community knowledge} by creating, updating, or confirming information about existing bike paths.
    
    \item[\textbf{[G5]}] \textbf{Registered users can view general and per-trip statistics} derived from their recorded cycling activities, supporting awareness and motivation in their performances.
\end{itemize}
...
While following a route, the user can visualize their position on the map and receive turn-by-turn navigation instructions toward the chosen destination. Additionally, the system may provide \textbf{notifications} about obstacles or particular conditions along the path.
