...
\begin{itemize}
    \item[\textbf{[G1]}] \textbf{Cycling activities are recorded and traceable over time}, allowing registered users to monitor their trips and review their past performances.
    
    \item[\textbf{[G2]}] \textbf{Users can access accurate and up-to-date information about bike paths}, including their status and possible obstacles, to support safe and informed cycling.
    
    \item[\textbf{[G3]}] \textbf{Users can discover optimal and safe biking routes} between two locations based on the quality and effectiveness of available bike paths.
