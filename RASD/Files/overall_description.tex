...
\begin{itemize}
	...
	\item[\textbf{[D2]}] The manual input provided by the logged-in users is accurate and complete as intended for a path entry.

	\item[\textbf{[D3]}] The external meteorological service is operational and accessible by the system.

	\item [\textbf{[D4]}] The users' mobile devices are equipped with GPS, and they have granted the BBP application location permissions and motion sensor access.
