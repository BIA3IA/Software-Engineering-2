...
\begin{itemize}
	\item \textbf{User Registration and Login}:
	      ...
	      Guest Users can browse available bike paths, search for routes between two locations, and receive path suggestions based on community rankings, but they can't record trips, create new paths, or contribute by making reports.
