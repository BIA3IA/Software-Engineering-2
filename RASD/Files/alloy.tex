...
\begin{figure}[H]
    \centering
    \subfloat[User selects a suggested path\label{fig:alloy-step-3}]{%
        \includegraphics[width=0.65\linewidth]{../Images/Alloy/3.png}%
    }%
    \hfill
    \subfloat[User starting the trip\label{fig:alloy-step-4}]{%
        \includegraphics[width=0.65\linewidth]{../Images/Alloy/4.png}%
    }
    \caption{User selection and trip initialization}
\end{figure}
...
\begin{figure}[H]
    \centering
    \subfloat[User moving to the next segment\label{fig:alloy-step-5}]{%
        \includegraphics[width=0.57\linewidth]{../Images/Alloy/5.png}%
    }%
    \hfill
    \subfloat[User arrives at destination\label{fig:alloy-step-6}]{%
        \includegraphics[width=0.57\linewidth]{../Images/Alloy/6.png}%
    }
    \caption{Completion of the first trip}
\end{figure}
...
\begin{figure}[H]
    \centering
    \subfloat[Second origin/destination selection\label{fig:alloy-step-8}]{%
        \includegraphics[width=0.55\linewidth]{../Images/Alloy/8.png}%
    }%
    \hfill
    \subfloat[Second path suggestion\label{fig:alloy-step-9}]{%
        \includegraphics[width=0.55\linewidth]{../Images/Alloy/9.png}%
    }
    \caption{Beginning of the second trip cycle}
\end{figure}
...
\begin{figure}[H]
    \centering
    \subfloat[User starting the trip\label{fig:alloy-step-g1}]{%
        \includegraphics[width=0.7\linewidth]{../Images/Alloy/g1.png}%
    }%
    \hfill
    \subfloat[User moving to the next segment\label{fig:alloy-step-g2}]{%
        \includegraphics[width=0.7\linewidth]{../Images/Alloy/g2.png}%
    }
    \caption{Guest user starting the trip and moving along the path}
\end{figure}
...
\begin{figure}[H]
    \centering
    \subfloat[User arrives at destination\label{fig:alloy-step-g3}]{%
        \includegraphics[width=0.7\linewidth]{../Images/Alloy/g3.png}%
    }%
    \hfill
    \subfloat[State after trip finalization\label{fig:alloy-step-g4}]{%
        \includegraphics[width=0.7\linewidth]{../Images/Alloy/g4.png}%
    }
    \caption{Completion and finalization of the Guest user's trip}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\linewidth]{../Images/Alloy/12.png}
