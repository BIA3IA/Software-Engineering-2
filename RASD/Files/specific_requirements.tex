...
\begin{table}[H]
	...
	\begin{tabularx}{\textwidth}{|p{0.25\textwidth}|X|}
		...
		\textbf{Entry Condition} & The actor is authenticated and is on his account page.                                                                                         \\ \hline
...
\begin{table}[H]
	...
	\begin{tabularx}{\textwidth}{|p{0.25\textwidth}|X|}
		...
		\textbf{Event Flow}      & 1. The actor accesses the “My Paths” section.                                                               \\
		                         & 2. The system displays the list of the actor's paths.                                                       \\
		                         & 3. The actor selects a path and requests its deletion.                                                      \\
		                         & 4. The system processes the request and deletes the corresponding path.                                     \\ \hline
		\textbf{Exit Condition}  & The selected path is permanently deleted and no longer visible in the actor's list.                         \\ \hline
		\textbf{Exceptions}      & If a temporary connection or BBP error occurs, the system displays an error message and allows retry later. \\ \hline
...
\begin{figure}[H]
	\centering
	\includegraphics[width=\textwidth]{Images/SequenceDiagrams/start_trip_guest.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=\textwidth]{Images/SequenceDiagrams/start_trip_logged.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=\textwidth]{Images/SequenceDiagrams/stop_trip_guest.png}
...
\begin{table}[H]
	...
	\begin{tabularx}{\textwidth}{|p{0.25\textwidth}|X|}
		...
		\textbf{Event Flow}      & 1. The actor chooses to stop the current trip.                                                                                          \\
		                         ...
		                         & 5. The system displays a confirmation and a summary view.                                                                               \\ \hline
...
\begin{figure}[H]
	\centering
	\includegraphics[width=\textwidth]{Images/SequenceDiagrams/stop_trip_logged.png}
...
\begin{table}[H]
	...
	\begin{tabularx}{\textwidth}{|p{0.25\textwidth}|X|}
		\hline
		\textbf{Actor(s)}        & Logged-in User                                                                                                                                                                                                            \\ \hline
		\textbf{Entry Condition} & The actor is performing a trip where existing reports have been registered by other users.                                                                                                                                \\ \hline
...
\textbf{[UC16]} - Edit Personal Profile
\begin{table}[H]
	\centering
	\label{tab:UC16}
	\begin{tabularx}{\textwidth}{|p{0.25\textwidth}|X|}
...
% (Opzionale) Diagramma di sequenza corrispondente
\begin{figure}[H]
	\centering
...
\textbf{[UC17]} - Manage Profile Visibility
\begin{table}[H]
	\centering
	\label{tab:UC17}
	\begin{tabularx}{\textwidth}{|p{0.25\textwidth}|X|}
		...
		\textbf{Entry Condition} & The actor is authenticated and is on the personal profile settings page.                                                           \\ \hline
		\textbf{Event Flow}      & 1. The actor opens the “Privacy and Visibility” section.                                                                           \\
		                         & 2. The system displays the current visibility preferences (e.g., “Public”, “Private”).                                             \\
		                         & 3. The actor selects whether to share personal and trip-related information publicly or keep it private.                           \\
		                         & 4. The system saves the chosen visibility setting.                                                                                 \\
		                         & 5. The updated preference is applied to the actor's profile and trip visibility.                                                   \\ \hline
		\textbf{Exit Condition}  & The actor's visibility settings are updated.                                                                                       \\ \hline
		\textbf{Exceptions}      & If the new preference cannot be saved (temporary connection or BBP error occurs), the system displays an error and allows retry.   \\ \hline
		\textbf{Notes}           & Profile visibility affects how other users see the actor's trips and statistics. No data are deleted when switching between modes. \\ \hline
	\end{tabularx}
	\caption{Manage Profile Visibility Process Detail}
\end{table}

\begin{figure}[H]
	\centering
	\includegraphics[width=\textwidth]{Images/SequenceDiagrams/manage_visibility.png}
	\caption{Manage Profile Visibility Sequence Diagram}
	\label{fig:use_case_manage_visibility}
\end{figure}

\textbf{[UC18]} - View Trip History
\begin{table}[H]
	\centering
	\label{tab:UC18}
	\begin{tabularx}{\textwidth}{|p{0.25\textwidth}|X|}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=\textwidth]{Images/SequenceDiagrams/view_trip_history.png}
