...
\begin{table}[H]
	...
	\end{tabularx}
	\caption{Start a Trip (Logged-in User, Manual Mode) Process Detail}
\end{table}
...
\textbf{[UC11]} - Start a Trip in Automatic Mode as aLogged-in User
\begin{table}[H]
	\centering
	\label{tab:UC11}
	\begin{tabularx}{\textwidth}{|p{0.25\textwidth}|X|}
	...
	\end{tabularx}
	\caption{Start a Trip in Automatic Mode as aLogged-in User Process Detail}
\end{table}
