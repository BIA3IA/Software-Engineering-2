...
\begin{table}[H]
	...
	\begin{tabularx}{\textwidth}{|p{0.25\textwidth}|X|}
		...
		\textbf{Exceptions}      & If data are invalid or incomplete, the system displays an error message and prevents saving until corrected.                                                   \\
		                         & If the provided email or username is already in use, the system displays an error message and prevents saving.                                                 \\
		                         & If a temporary connection or BBP error occurs, the system displays an error message and allows retry.                                                          \\ \hline
...
\begin{table}[H]
	...
	\begin{tabularx}{\textwidth}{|p{0.25\textwidth}|X|}
		...
		\textbf{Exceptions}      & If the inputs are invalid or incomplete, the system displays an error message.                          \\
		                         & If no route is found, the system displays an empty list message.         \\
...
\begin{table}[H]
	...
	\begin{tabularx}{\textwidth}{|p{0.25\textwidth}|X|}
		...
		\textbf{Event Flow}      & 1. The actor selects one path from the results list.                                                                         \\
		                         & 2. The system displays the path details (overview, distance, ranking, segments, reports).          \\ \hline
...
\begin{table}[H]
	...
	\begin{tabularx}{\textwidth}{|p{0.25\textwidth}|X|}
		...
		\textbf{Event Flow}      & 1. The actor selects the creation button.                                                                                                      \\
		                         ...
		                         & 4. The system validates the provided metadata.                                                                                                 \\
		                         & 5. If validation succeeds, the system continuously collects position data.                                                                    \\
		                         & 6. When tracking stops, the system validates the collected position data.                                                                      \\
		                         & 7. If validation succeeds, the system saves the new path.                                                                                      \\ \hline
...
\begin{table}[H]
	...
	\begin{tabularx}{\textwidth}{|p{0.25\textwidth}|X|}
		...
		\textbf{Event Flow}      & 1. The actor chooses to start the trip on the selected path.                                                                \\
		                         ...
		                         & 3. While the trip is active, the system receives position updates from the GPS and updates the actor's position on the map. \\ \hline
...
\begin{table}[H]
	...
	\begin{tabularx}{\textwidth}{|p{0.25\textwidth}|X|}
		...
		\textbf{Event Flow}      & 1. The actor chooses to start the trip on the selected path.                                                                                    \\
		                         ...
		                         & 4. The system displays the path on the map.                                                                                                           \\
...
\begin{table}[H]
	...
	\begin{tabularx}{\textwidth}{|p{0.25\textwidth}|X|}
		...
		\textbf{Event Flow}      & 1. The actor chooses to start the trip on the selected path.                                                                                                                                  \\
		                         ...
		                         & 5. If the connection succeeds, the system displays the path on the map.                                                                                                                                \\
...
\begin{table}[H]
	...
	\begin{tabularx}{\textwidth}{|p{0.25\textwidth}|X|}
		...
		\textbf{Event Flow}      & 1. The actor chooses to stop the trip, leaves the app or deviates from the path.         \\
		                         & 2. The system ends the map visualization.                         \\ \hline
...
\begin{table}[H]
	...
	\begin{tabularx}{\textwidth}{|p{0.25\textwidth}|X|}
		...
		\textbf{Event Flow}      & 1. The actor chooses to stop the current trip, leaves the app or deviates from the path.                                                            \\
		                         & 2. The system disconnects external devices (if any).                                                                         \\
...
\begin{table}[H]
	...
	\begin{tabularx}{\textwidth}{|p{0.25\textwidth}|X|}
		...
		\textbf{Exceptions}      & If no trips are available, the system returns empty statistics.   \\
		                         & If a temporary connection or BBP error occurs, the system displays an error message.            \\ \hline
