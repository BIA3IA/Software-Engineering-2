...
\begin{table}[H]
	...
	\begin{tabularx}{\textwidth}{|p{0.25\textwidth}|X|}
		...
		\textbf{Event Flow}      & 1. The actor clicks on the “Sign Up” button.                                                          \\
		                         ...
		                         & 5. If validation succeeds, the system creates a new account and redirects the actor to the home page. \\ \hline
...
\begin{table}[H]
	...
	\begin{tabularx}{\textwidth}{|p{0.25\textwidth}|X|}
		...
		\textbf{Event Flow}      & 1. The actor enters start and destination points.                                                                  \\                                                              \\
		                         ...
		                         & 3. The system displays the list of suggested routes to the actor.                                                  \\ \hline
...
\begin{table}[H]
	...
	\begin{tabularx}{\textwidth}{|p{0.25\textwidth}|X|}
		...
		\textbf{Event Flow}      & 1. The actor accesses his path section.                                                                                \\
...
\begin{table}[H]
	...
	\begin{tabularx}{\textwidth}{|p{0.25\textwidth}|X|}
		...
		\textbf{Event Flow}      & 1. The actor taps on the visibility indicator of a specific path.                                                                                                                                                                            \\
		                         & 2. The system displays a confirmation dialog to switch the path visibility (e.g., from Private to Public or vice versa).                                                                                                                     \\
		                         & 3. The actor confirms the action and submits the changes.                                                                                                                                                                                    \\
...
\begin{table}[H]
	...
	\begin{tabularx}{\textwidth}{|p{0.25\textwidth}|X|}
		...
		\textbf{Event Flow}      & 1. The actor accesses his trip history section.                                           \\
		                         & 2. The system displays the trips associated with the actor.                               \\
		                         & 3. The actor can select a specific trip to view detailed data (map, statistics, reports). \\
...
\begin{table}[H]
	...
	\begin{tabularx}{\textwidth}{|p{0.25\textwidth}|X|}
		...
		\textbf{Event Flow}      & 1. The actor accesses his statistics section.                                                                 \\
...
\begin{table}[H]
	...
	\begin{tabularx}{\textwidth}{|p{0.25\textwidth}|X|}
		\hline
		\textbf{Actor(s)}        & Logged-in User                                                                                                                    \\ \hline
		\textbf{Entry Condition} & The actor is authenticated, has completed one or more trips and is visualizing his trips section.                                 \\ \hline
