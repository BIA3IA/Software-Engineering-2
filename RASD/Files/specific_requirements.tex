...
\begin{enumerate}
	...
	\item \textbf{Path Information Management}
	      \begin{itemize}
		      ...
		      \item[\textbf{[R26]}] The system shall allow logged-in users to manually report obstacles or problems on a bike path.
		      ...
		      \item[\textbf{[R29]}] The system shall allow logged-in users to delete or edit their previously created paths.
